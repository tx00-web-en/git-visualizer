...
const freeWithRemote = {
  title: 'Free Explore with Remote',
  key: 'free-remote',
  message: 'Have fun!',
  commitData: [{ id: 'e137e9b', tags: ['main', 'origin/main'], message: 'first commit' }],
...
const demos = [free, freeWithRemote, upstreamChanges, rewrittenHistory, revert, cherryPick];
